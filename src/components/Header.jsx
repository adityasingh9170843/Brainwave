...
function Header() {
  ...
  return (
    <div className={`fixed top-0 left-0 z-50 w-full border-b border-[#252134] lg:bg-[#0E0C15]/90 lg:backdrop-blur-sm ${openNavigation ? "bg-[#0E0C15]" : "bg-[#0E0C15]/90 backdrop:-blur-sm"}`}>
